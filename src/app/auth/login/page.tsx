            ...
            >
                ...
                <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/50 space-y-6">
                    ...
                    <form onSubmit={handleEmailLogin} className="space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="flex justify-end pr-1">
                                <Link href="#" className="text-[13px] font-semibold text-indigo-600 hover:text-indigo-700">Forgot password?</Link>
                            </div>
                        </div>
                    ...
                    <p className="text-center text-[15px] font-medium text-slate-500">
                        ...
                        <Link href="/auth/signup" className="text-indigo-600 font-bold hover:text-indigo-700">
                            Sign up
                        </Link>
                    </p>
                </div>
